...
namespace eval ::optrace {
  variable script "C:/VivadoProjects/Exercise4/Task 3/Exercise4.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{C:/VivadoProjects/Exercise4/Task 3/Exercise4.runs/synth_1/top.dcp}}
